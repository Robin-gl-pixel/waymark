 ...
 * card. Teaches the Pinti Share flow in three annotated slots without leaving
 * the app:
 *
 *   1. Instagram post/reel → tape le bouton Partager (avion papier).
 *   2. Share sheet iOS     → choisis « Pinti Share ».
 *   3. Preview Pinti       → confirme le lieu et sauvegarde.
 *
...
const SLOTS: readonly Slot[] = [
  ...
  },
  {
    icon: 'share-outline',
    eyebrow: 'Étape 2',
    body: 'Dans la share sheet iOS, choisis « Pinti Share ».',
  },
  {
    icon: 'map-outline',
    eyebrow: 'Étape 3',
    body: 'Pinti reçoit le média, détecte le lieu et l\'épingle sur ta carte.',
  },
] as const;
  ...
  return (
    ...
    >
      <View style={styles.backdrop} accessibilityViewIsModal>
        ...
        >
          <Text style={styles.eyebrow}>Tuto Pinti Share</Text>
          <Text style={styles.title}>Depuis Instagram</Text>
          <Text style={styles.subtitle}>
            Partage un post ou un reel Insta vers Pinti Share : on détecte le
