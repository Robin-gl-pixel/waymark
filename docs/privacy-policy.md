---
title: Politique de confidentialité — Pinti
layout: default
---

# Politique de confidentialité — Pinti
...
Pinti est un carnet de lieux personnel. On ne vend rien, on ne track pas, on ne partage tes données avec personne.
...
Pinti est développé par Robin Hesse, développeur indépendant basé en France. Contact : hesserobin1234@gmail.com.
...
Uniquement pour faire fonctionner Pinti :
...
Pour faire fonctionner Pinti, nous utilisons ces services :
...
Étant basé en France, Pinti respecte le RGPD. Tu as le droit :
...
- L'authentification passe par Sign in with Apple (0 mot de passe manipulé côté Pinti)
- Les règles Firebase Firestore et Storage isolent strictement les données par utilisateur (`request.auth.uid == userId`)

## 10. Enfants

Pinti n'est pas conçu pour les moins de 13 ans. Nous ne collectons pas sciemment de données auprès d'enfants.
