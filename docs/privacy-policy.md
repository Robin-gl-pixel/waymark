---
title: Politique de confidentialité — Amble
layout: default
---

# Politique de confidentialité — Amble
...
Amble est un carnet de lieux personnel. On ne vend rien, on ne track pas, on ne partage tes données avec personne.
...
Amble est développé par Robin Hesse, développeur indépendant basé en France. Contact : hesserobin1234@gmail.com.
...
Uniquement pour faire fonctionner Amble :
...
Pour faire fonctionner Amble, nous utilisons ces services :
...
Étant basé en France, Amble respecte le RGPD. Tu as le droit :
...
- L'authentification passe par Sign in with Apple (0 mot de passe manipulé côté Amble)
- Les règles Firebase Firestore et Storage isolent strictement les données par utilisateur (`request.auth.uid == userId`)

## 10. Enfants

Amble n'est pas conçu pour les moins de 13 ans. Nous ne collectons pas sciemment de données auprès d'enfants.
