# Pinti — Competitive Velocity Map
...
- **Only two players today accept an Instagram screenshot as input: Stasht and DocentPro/SpotFetch.** Everyone else (Plotline, Rhyme, JoySpot, Stashed, Postcard, Mapstr) requires a share-sheet URL — which breaks on Stories, DMs, and cross-posted reels. That is Pinti' remaining moat, and it is *narrow*.
...
| # | Competitor | Status | Extraction today | Threat | Weakness Pinti exploits |
|---|---|---|---|---|---|
...
| 3 | **Plotline (getplotline.app)** | Live iOS, actively shipping | Share sheet only: IG, TikTok, YouTube, web URLs | **HIGH** | No screenshots; no Stories/DMs; iOS-only content-URL dependency |
| 4 | **DocentPro / SpotFetch** | Live iOS + Android, v1.5.11 (4 days ago) | Share sheet + **screenshots** (IG/TikTok/YT) | **MEDIUM-HIGH** | SpotFetch is a bolt-on inside an AI-itinerary product; buried UX |
| 5 | **JoySpot** | Live iOS + Android, v2.0.0 (~1 day ago) | IG + TikTok URLs (no screenshots) | **MEDIUM** | Only 4 ratings, 3.0★; paywall on premium; no screenshot mode |
| 6 | **Mapstr** | Live iOS/Android/web, mature | Manual + Foursquare/Swarm/GMaps import | **LOW-MEDIUM** | Zero social extraction; 300-place cap; fake IG integration |
| 7 | **Postcard** | Live iOS/macOS/visionOS, v1.1.16 (May 2026) | Share sheet URL + Google Maps link | **LOW-MEDIUM** | Social-first product; solo/unfunded; slow release cadence |
| 8 | **Stashed (Harrison Johnston)** | Live iOS, early | TikTok URL only | **LOW** | TikTok only; not enough ratings to surface; Instagram gap wide open |
| 9 | **Via (viatravelapp.com)** | Live — but not a competitor | Group trip planning; no IG/TikTok extraction | **NONE** | Article roundups conflate it with extraction apps; misidentified |

## Individual Velocity Cards

### 1. Rhyme (formerly Roamy) — HIGH
- **Status:** Live App Store, v1.4.1 released Jun 6, 2026. Developer: LOGOS STUDIO INC.
...
- **Weakness Pinti exploits:** Requires a share-sheet URL — cannot ingest Stories, DMs, or a friend's screenshot pasted in a group chat. Also paid; Pinti free is a wedge.

### 2. Stasht — HIGH
- **Status:** Live iOS + Android + web + Safari extension, v6.0.2 shipped ~5 days ago. Developer: Stasht LLC.
- **Extraction:** Screenshots, photos, links, and share-sheet posts from Instagram/TikTok/Pinterest/X/YouTube. **Directly overlaps Pinti' screenshot wedge.**
...
- **Weakness Pinti exploits:** Positioned as a universal saves inbox (map + calendar + reminders + recipes). Pinti wins on focus — a map, only a map. Stasht will lose casual users who just want "screenshot → pin."
...
- **Weakness Pinti exploits:** No screenshot ingestion — same URL-only limitation as Rhyme. Also heavily SEO-driven (blog farm), which reads as "top-of-funnel play," not viral product loop.

### 4. DocentPro / SpotFetch — MEDIUM-HIGH
- **Status:** Live iOS + Android, v1.5.11 (4 days ago), 4.8★ / 19 ratings. Developer: DocentPro Inc.
- **Extraction:** SpotFetch **now supports images/screenshots** in addition to IG/TikTok/YouTube URLs. This is the closest direct threat to Pinti' wedge.
...
- **Weakness Pinti exploits:** SpotFetch is buried inside a bigger itinerary product. A user who just wants a screenshot-to-pin app will bounce off the onboarding surface. Pinti wins on "one thing, done fast."
...
- **Weakness Pinti exploits:** 3.0★ signals UX pain; also monetizes aggressively pre-PMF. Pinti clean free experience wins early users.
...
- **Weakness Pinti exploits:** 300-place free cap, no screenshot extraction, no urgency to build one. Their user base skews power-users; Pinti grabs new savers from IG-native cohort.
...
- **Weakness Pinti exploits:** Social-first assumption (feeds, follows, creators) alienates the private-journal user. Slow release cadence + no screenshot mode = Pinti can leapfrog before v1.2 lands.
...
- **Weakness Pinti exploits:** Instagram not supported — Pinti takes the entire IG surface. Also URL-only.
...
- **Threat:** None to Pinti. Ignore.

### Others discovered
- **Triply** — content-farm blog, not an app of note.
- **TokSpot** — video→pin, small, listed but no meaningful traction found.
- **Sorti (letitsorti.com)** — universal saves inbox positioning like Stasht; watch but not primary.
- **Tabi** — referenced in Plotline vs Tabi post; niche, watch only.
- **mio: save places** — new App Store listing, early, unranked.
- **TravelTreasure** — early save-places app, unranked.

## Speed Recommendations for Pinti
...
2. **Own the "screenshot" keyword before Rhyme/Plotline do.** They rank for "save Instagram places" via SEO. Register the domain, publish one comparison post ("Pinti vs Plotline: screenshot vs share sheet"), and get your App Store title to include "screenshot" (e.g. "Pinti: Screenshot to Map"). This is the exact wedge Stasht already understands — do not let them out-SEO you.
...
- [Plotline landing](https://getplotline.app/) · [Plotline: Best Apps 2026](https://getplotline.app/blog/best-apps-save-locations-tiktok-instagram) · [Plotline App Store](https://apps.apple.com/app/plotline-travel-map-planner/id6759443026)
- [Stasht landing](https://stasht.app/) · [Stasht App Store](https://apps.apple.com/us/app/stasht-app-save-social-inspo/id6756032175) · [Silicon Snark review](https://www.siliconsnark.com/stasht-turns-your-saved-posts-into-a-map-calendar-and-mild-accusation/)
- [Rhyme App Store](https://apps.apple.com/us/app/rhyme-formerly-roamy/id6748781672) · [Rhyme.travel](https://www.rhyme.travel/)
- [DocentPro / SpotFetch App Store](https://apps.apple.com/us/app/docentpro-ai-travel-planner/id6474295519)
- [JoySpot App Store](https://apps.apple.com/us/app/joyspot-import-from-anywhere/id6745341190) · [JoySpot landing](https://joyspot.app/)
- [Stashed App Store](https://apps.apple.com/au/app/stashed-save-tiktok-places/id6747645573)
- [Postcard App Store](https://apps.apple.com/us/app/postcard-travel-maps-recs/id1607191398) · [Postcard Crunchbase](https://www.crunchbase.com/organization/postcard)
- [Mapstr App Store](https://apps.apple.com/us/app/mapstr-save-follow-places/id917288465) · [Mapstr FAQ](https://en.mapstr.com/faq)
- [Via Group Travel App Store](https://apps.apple.com/ca/app/via-group-travel/id6740332067) · [viatravelapp.com](https://www.viatravelapp.com/) — confirms Via is group trips, not extraction
- [Map Your Voyage: Best Apps to Plan Trips from Social Media 2026](https://mapyourvoyage.com/blog/best-apps-to-plan-trips-from-social-media) · [Triply roundup](https://triply.au/blog/best-apps-save-travel-places-instagram-tiktok/)
